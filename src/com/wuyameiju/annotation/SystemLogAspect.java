package com.wuyameiju.annotation;    
import com.wuyameiju.entity.user;    
import com.wuyameiju.service.impl.logServiceImpl;    
import com.wuyameiju.util.DateUtil;    
import com.wuyameiju.util.JSONUtil;    
     ...
     public  void doBefore(JoinPoint joinPoint) {    
        ...
        String ip = request.getRemoteAddr();    
         try {    
            ...
            log.setCreateDate(DateUtil.getNowDate().toString());    
            //保存数据库    
            logService.add(log);    
