							...
							<fieldset>
								<div>
									<label > <input id="phone"
										placeholder="手机号" value=""> <br> 
										<span id="spanphone1" style="display:none" >*不是有效的手机号.</span>
								...
								<div>
									<label > <input type="password"
										id="password2" placeholder="确认密码" value=""> <br>
										<span id="spanpass2" style="display:none">*密码不一致.</span>
									</label>
								</div>
